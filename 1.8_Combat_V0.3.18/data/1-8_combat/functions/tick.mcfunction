...
scoreboard players enable @a tgl-1.8-combat
execute as @a[scores={tgl-1.8-combat=1}] run function 1-8_combat:combat_on
execute as @a[scores={tgl-1.8-combat=3..}] run function 1-8_combat:combat_off
